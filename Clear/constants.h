...
const std::array<int, NUM_PIECES> isPawn = {false, true, false, false, false, false, false, true, false, false, false, false, false};	
const std::array<int, NUM_PIECES> isKnight = {false, false, true, false, false, false, false, false, true, false, false, false, false};
const std::array<int, NUM_PIECES> isKing = {false, false, false, false, false, false, true, false, false, false, false, false, true};
const std::array<int, NUM_PIECES> isRookQueen = {false, false, false, false, true, true, false, false, false, false, true, true, false};
const std::array<int, NUM_PIECES> isBishopQueen = {false, false, false, true, false, true, false, false, false, true, false, true, false};
const std::array<int, NUM_PIECES> isSlider = {false, false, false, true, true, true, false, false, false, true, true, true, false};
