...
namespace Utils {
    ...
    bool isPieceValid(const int piece) {
        if (piece >= PIECE::WP && piece <= PIECE::BK) {
            return true;
        } else {
            return false;
        }
    ...
    bool isPieceValidOrEmpty(const int piece) {
        if (piece >= PIECE::EMPTY && piece <= PIECE::BK) {
            return true;
        } else {
            return false;
        }
    ...
    int createMoveInt(const int fromSq, const int toSq, const int capture, const int promortion, const int flag) {
